...
<div class="space-y-1.5">
    ...
    <textarea
        ...
        rows="{{ $rows }}"
        {!! $attributes->merge([
            'class' => 'block w-full rounded-xl border px-3.5 py-2 text-sm text-slate-900 shadow-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-offset-0 transition ' .
                ($hasError
