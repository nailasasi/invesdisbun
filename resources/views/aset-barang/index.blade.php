                    ...
                    @forelse ($pegawaiList as $i => $pegawai)
                        <tr class="transition hover:bg-slate-50">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 text-right text-sm">
                                <a href="{{ route('aset-barang.show', $pegawai->id_pegawai) }}" class="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-2.5 py-1.5 text-xs font-medium text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-50">
